...
DO $$ BEGIN
 ALTER TABLE "usersToRoles" ADD CONSTRAINT "usersToRoles_applicationId_applicatons_id_fk" FOREIGN KEY ("applicationId") REFERENCES "applicatons"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
